...
class SearchBarang (private var idbarang: Int, private var code: String, private var namaBarang: String, private var stok: Int, private var harga: Int, private var jumlah: Int) {
